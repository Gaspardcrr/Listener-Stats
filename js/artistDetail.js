...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    async function loadArtistHistoryAndRenderChart(name) {
        ...
        const subdirectory = getArtistSubdirectory(name); // Utilise le nom d'artiste original pour la détermination du sous-dossier
        const dataFilePath = `./data/${subdirectory}/${cleanedName}.csv`; // Chemin avec le sous-dossier

        const history = await parseCSV(dataFilePath);
